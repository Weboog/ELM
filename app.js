...
var $author$project$PhotoGroove$update = F2(
	function (msg, model) {
		return (msg.description === 'SelectedServer') ? _Utils_update(
			model,
			{selectedServer: msg.data}) : model;
	});
...
var $author$project$PhotoGroove$buildServer = F2(
				...
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							'default',
							_Utils_eq(_default, server.id))
						])),
					$elm$html$Html$Events$onClick(
					{data: server.id, description: 'SelectedServer'})
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Id : '),
					$elm$html$Html$text(
					$elm$core$String$fromInt(server.id)),
					A2(
					$elm$html$Html$span,
					_List_Nil,
					_List_fromArray(
						[
							...
							$elm$html$Html$text(server.location)
						]))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Hello Guys this is my first ELM app')
					])),
				A2(
				$elm$html$Html$ul,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('server_list')
					]),
				A2(
					$elm$core$List$map,
					$author$project$PhotoGroove$buildServer(model.selectedServer),
					model.servers))
			]));
};
